          ...
          <div className="relative w-full px-8 py-10 mt-12 bg-yellow-200 sm:p-12 md:mt-0 md:px-8 md:py-10 lg:p-12 md:-translate-y-80 rounded-3xl">
            <div className="flex flex-col justify-between">
              <div className="flex-1">
                ...
                <p className="max-w-2xl mt-3 text-lg leading-loose text-purple-800">
                  In this education environment, each child is well equipped to
                  acquire knowledge and life skills in the following years
                </p>
                <div className="relative mt-8 aspect-w-3 aspect-h-2">
                  <img
                    className="object-cover rounded-2xl"
            ...
            <div className="flex flex-col justify-between">
              <div className="flex-1">
                ...
                <p className="max-w-2xl mt-3 text-lg leading-loose text-purple-800">
                  ...
                  independently and to quickly and efficient solve problems, we
                  have created a community for indepedent individuals to learn
                  to live together
                </p>
                <div className="relative mt-8 aspect-w-3 aspect-h-2">
                  <img
