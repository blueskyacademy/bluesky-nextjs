...
const CallAction = ({ title, content, bottomSpacing }) => {
  ...
  return (
    <>
      <div
        className={`fixed right-0 mr-8 mb-2 hover:bg-blue-`}
        style={{ bottom: "120px" }}
      >
        <div
          className='bg-bluesky-900 text-white rounded-lg shadow-md px-6 py-3 cursor-pointer mb-1'
          style={{
            borderRadius: "20px",
          }}
        >
      ...
      >
        <div
          className='bg-bluesky-900 text-white rounded-lg shadow-md px-6 py-3 cursor-pointer'
          style={{
            borderRadius: "20px",
          }}
        >
